...
function mapEquipment(
  ...
  return {
    ...
    objectId: textValue(location, ["id"]) || textValue(equipment, ["location_id"]),
    objectQrCode: textValue(location, ["qr_code", "code"]),
...
export default function EquipmentPassportPage() {
  ...
  return (
    <AppShell
      title="Паспорт на оборудване"
      description="Идентификация, обект и история на обслужване"
    >
      {loadState === "loading" ? (
      ...
      {equipment ? (
        <div className="space-y-5">
          <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            <Link
              href={
                equipment.objectQrCode
                  ? `/locations/${encodeURIComponent(equipment.objectQrCode)}`
                  : "/locations"
              }
            ...
            <div className="grid gap-0 lg:grid-cols-[1fr_320px]">
              <div className="p-5">
                ...
                <div className="mt-6 grid gap-3 md:grid-cols-2 xl:grid-cols-3">
                  ...
                  <DetailTile label="Вид" value={equipment.category || equipment.type} />
                  ...
                  />
                  <DetailTile
                    label="Първо въвеждане"
                    value={formatDateValue(equipment.createdAt)}
                  />
                  <DetailTile
              ...
              <div className="border-t border-slate-100 bg-slate-50 p-5 lg:border-l lg:border-t-0">
                <div className="space-y-3">
                  ...
                  <div className="flex items-start gap-3 rounded-2xl bg-white p-4">
                    <UserRound className="mt-0.5 text-orange-500" size={18} />
                    <div>
                      <div className="text-xs font-black uppercase text-slate-400">
                        Вътрешна локация
                      </div>
          ...
          <Card className="p-5">
            <div className="flex items-center justify-between gap-3">
              <div>
                ...
                <p className="mt-1 text-sm font-medium text-slate-500">
                  Протоколи и сервизни действия за този запис.
                </p>
              </div>
            ...
            {history.length === 0 ? (
              <div className="mt-5 rounded-2xl border border-dashed border-slate-200 bg-slate-50 p-5 text-sm font-bold text-slate-500">
              ...
              <div className="mt-5 divide-y divide-slate-100">
                {history.map((row) => (
                  <div
                    key={row.id}
                    className="grid gap-3 py-4 md:grid-cols-[180px_1fr_160px]"
                  >
